...
void init_state() {
    ...
    bmsconf.OVPT = 42000;
    bmsconf.UVPT = 30000;
    bmsconf.current_offset = 30140;
    bmsconf.OT_th = 9000; // 45C // Deze waarden zijn voor het laden. strenger dan ontladen
    bmsconf.UT_th = 20000; // 10C

    // OCP configuration
    bmsconf.OCP_d_th = -30000; // Voor LV met 100x: 1000b per A
    bmsconf.OCP_c_th = 3600;
